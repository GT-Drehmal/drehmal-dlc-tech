...
scoreboard objectives add tgrptch.corvidiot_accept trigger
scoreboard objectives add tgrptch.daniel_accept trigger
scoreboard objectives add tgrptch.dome_accept trigger
scoreboard objectives add tgrptch.dread_accept trigger
